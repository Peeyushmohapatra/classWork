const emojiList = [
  ...
  const felling = document.getElementsByClassName('felling')[0];
  const newName = document.getElementsByClassName("newname")[0];
  const parent = document.getElementsByClassName('main')[0];
  const newEle = document.createElement('div');
    newEle.setAttribute('class','icon');
    newEle.innerHTML = `<h1 class="emoji">😀</h1>
    <h3 class="felling">Happy</h3>
    <h3 class="newName">Happy Face</h3>`
